...
;;; NOTE: upstream ends this section with a #!eof marker followed by example
;;; code. We truncate at the marker (the reader stops there anyway) so the file
;;; is valid under Chez R6RS / compile-program.
