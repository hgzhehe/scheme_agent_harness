...
[`../docs/PLAN.md`](../docs/PLAN.md). Its bet is simple: make the agent's
...
4. the built-in prompt — mirrored in [`SYSTEM.md`](SYSTEM.md)
...
standalone executable, and [`../docs/PLAN.md`](../docs/PLAN.md) for the roadmap.
